    ...
    public function settings_page_content()
    {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                <?php
                settings_fields('mobicred-woocommerce');
                do_settings_sections('mobicred-woocommerce');
                ?>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="mobicred_inject_location">
                                <option value="woocommerce_before_single_product_summary" <?php selected(get_option('mobicred_inject_location'), 'woocommerce_before_single_product_summary'); ?>>Before single product summary</option>
                                <option value="woocommerce_single_product_summary" <?php selected(get_option('mobicred_inject_location'), 'woocommerce_single_product_summary'); ?>>Inside single product summary</option>
                            </select>
                        </td>
                    </tr>
                </table>
